...
data class SysColorScheme(
    ...
    fun asStylesheet(): StyleSheet = StyleSheet().apply {
        ...
        universal style {
            ...
            CSSMaterialTheme.colors.error(sysColorError)
            CSSMaterialTheme.colors.errorContainer(sysColorErrorContainer)
            ...
            CSSMaterialTheme.colors.onSurface(sysColorOnSurface)
            ...
            CSSMaterialTheme.colors.onSurfaceVariant(sysColorOnSurfaceVariant)
