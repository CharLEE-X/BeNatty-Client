...
object Palette {
    object Light {
        ...
        val onBackground = Color(0x111111)
        val surface = Color(0xC4C4C4)
        val onSurface = Color(0x111111)
        val primary = Color(0x9A7F6AFF)
        val onPrimary = Color.White
        val accent = Color(0xCEDFDCFF)
        val onAccent = Color(0x111111)
    }

    object Dark {
        val background = Color(0x111111)
        val onBackground = Color.White
        val surface = Color(0x262528)
        val onSurface = Color.White
        val primary = Color(0x9A7F6AFF)
        val onPrimary = Color.White
        val accent = Color(0x384946)
        val onAccent = Color(0x111111)
    }
}
...
val onBackgroundLight = Color(0x000000)
val surfaceLight = Color(0xC4C4C4)
...
val backgroundDark = Color(0x000000)
val onBackgroundDark = Color(0xFFFFFF)
